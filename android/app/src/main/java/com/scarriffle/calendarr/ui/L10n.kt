...
object L10n {
    ...
    private val strings: Map<String, Map<String, String>> = mapOf(
        "de" to mapOf(
            ...
            "event.attachments" to "Anhänge", "event.attachment_add" to "Datei hinzufügen",
            "event.attachment_hint" to "Max. 10 MB pro Datei, 10 Dateien. PDF, Bilder, Text.",
            ...
            "sso.or" to "oder", "sso.login_with" to "Mit %s anmelden",
            "sso.err.generic" to "Anmeldung fehlgeschlagen",
            "sso.err.oidc_failed" to "Anmeldung fehlgeschlagen",
            "sso.err.oidc_provider_unreachable" to "Anmeldedienst nicht erreichbar",
            "sso.err.oidc_no_browser" to "Kein Browser installiert — für die Anmeldung wird einer benötigt",
            "sso.err.oidc_account_not_linked" to "Kein verknüpftes Calendarr-Konto. Bitte lokal anmelden und in den Einstellungen verknüpfen.",
            "sso.err.oidc_signup_disabled" to "Automatische Kontoerstellung ist deaktiviert",
            "sso.err.oidc_domain_not_allowed" to "Diese E-Mail-Domain ist nicht zugelassen",
            "sso.err.oidc_email_conflict" to "Diese E-Mail-Adresse gehört bereits zu einem anderen Konto",
            "sso.err.oidc_email_not_verified" to "E-Mail-Adresse beim Anbieter nicht bestätigt",
            "sso.err.oidc_no_email" to "Der Anbieter hat keine E-Mail-Adresse übermittelt",
            "sso.err.oidc_unknown_client" to "Diese App ist beim Anbieter nicht registriert",
            "sso.err.oidc_invalid_token" to "Das Anmelde-Token ist ungültig",
            "sso.err.oidc_no_id_token" to "Der Anbieter hat kein ID-Token geliefert",
        ),
        "en" to mapOf(
            ...
            "event.attachments" to "Attachments", "event.attachment_add" to "Add file",
            "event.attachment_hint" to "Max. 10 MB per file, 10 files. PDF, images, text.",
            ...
            "auth.back" to "Back",
            // Single sign-on (OpenID Connect)
            "sso.or" to "or", "sso.login_with" to "Sign in with %s",
            "sso.err.generic" to "Sign-in failed",
            "sso.err.oidc_failed" to "Sign-in failed",
            "sso.err.oidc_provider_unreachable" to "Sign-in service unreachable",
            "sso.err.oidc_no_browser" to "No browser installed — signing in requires one",
            "sso.err.oidc_account_not_linked" to "No linked Calendarr account. Sign in locally and link it in Settings.",
            "sso.err.oidc_signup_disabled" to "Automatic account creation is disabled",
            "sso.err.oidc_domain_not_allowed" to "This email domain is not allowed",
            "sso.err.oidc_email_conflict" to "That email address already belongs to another account",
            "sso.err.oidc_email_not_verified" to "Email address not verified at the provider",
            "sso.err.oidc_no_email" to "The provider did not supply an email address",
            "sso.err.oidc_unknown_client" to "This app is not registered with the provider",
            "sso.err.oidc_invalid_token" to "The sign-in token is invalid",
            "sso.err.oidc_no_id_token" to "The provider did not return an ID token",
        ),
    )
}
